...
class CapabilityRegistry:
    ...
    def register(self, spec: CapabilitySpec) -> None:
        from packages.capability.agents import validate_agent_spec
        from packages.capability.contract import (
            ToolContractError,
            validate_capability_contract,
        )
        from packages.capability.errors import CapabilityContractError
        from packages.capability.governance import validate_governance_declaration
    ...
    def bootstrap(self) -> None:
        ...
        builtin_n = 0
        try:
            from packages.capability.builtin import register_builtin_tools
