...
# 显式记忆命令：记住/请记住/记得/别忘了（吞冒号/逗号/顿号）
_RE_REMEMBER = re.compile(r"(?:请)?(?:记住|记得|别忘了)[:：,，、]?\s*(.{1,120})")
# 偏好句式：我喜欢/不喜欢/偏好/偏爱/习惯/爱 …
_RE_PREFERENCE = re.compile(r"(?:我|用户)\s*(喜欢|不喜欢|偏好|偏爱|习惯|爱)\s*(.{1,40})")
# 身份句式：我叫/我是 …
