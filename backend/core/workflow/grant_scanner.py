...
def scan_once() -> dict[str, Any]:
    from backend.core.workflow.grants import scan_grants_for_auto_renew

    result: dict[str, Any] = dict(scan_grants_for_auto_renew())
    try:
        from backend.core.workflow.grant_notify import scan_expiring_grants
        ...
        result["notify"] = {}
    try:
        from backend.core.workflow.subscription import scan_subscription_expiring
