...
from backend.core.workflow.node_exec import _child_terminal_outputs
from backend.core.workflow.runner_shared import _set_node_status
    ...
    *,
    ...
    with sf.Session() as session:
        ...
        if child.status == "succeeded":
            ...
            session.commit()
            from backend.core.workflow.run_lifecycle import schedule_resume_or_continue
