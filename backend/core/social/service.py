...
from backend.core.content_ops.style import get_org_content_profile
...
from backend.core.social.pipeline import fetch_only_marker, upsert_account_from_probe
from backend.core.social.queue import find_active_task
from backend.core.social.rate_limit import acquire_for_probe
from backend.core.social.usage import COST_PROBE, cost_alert_exceeded, record_usage
...
def stub_replica(
    ...
    *,
    ...
    from backend.core.social.templates import pick_template_for_replica
